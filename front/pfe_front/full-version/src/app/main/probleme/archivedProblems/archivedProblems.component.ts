...
@Component({
  ...
  templateUrl: './archivedProblems.component.html',
  styleUrls: ['./archivedProblems.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ArchivedProblemsComponent implements OnInit {
  // Private
  ...
  loadProblems(): void {
    ...
    if(this.authService.isClient) {
      this.problemeService.getAllArchivedProblemes().subscribe((data: Probleme[]) => {
  ...
  addProbleme() {
    ...
    this.problemeService.addProbleme(formData).subscribe(
        response => {
          ...
          this.problemeService.notifypeople(response.id, emails).subscribe(
              response => {
                console.log('People notified successfully', response);
                this.toggleModal();
                this.loadProblems();
  ...
  archiveProblem(id: any) {
    this.problemeService.unarchiveProbleme(id).subscribe(()=>{
      this.loadProblems()
    })
  }
}
