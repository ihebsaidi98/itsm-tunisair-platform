...
@Component({
  ...
  templateUrl: './incidentworker.component.html',
  styleUrls: ['./incidentworker.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class IncidentworkerComponent implements OnInit {
  ...
  loadIncidents(): void {
    this.incidentService.findIncidentsByUserId(this.userId).subscribe((data: Incident[]) => {
     this.incidents = []
