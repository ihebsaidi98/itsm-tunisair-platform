...
export const snippetCodeLeftAligned: snippetCode = {
  html: `
<div class="media-list">
  <div class="media">
    ...
    <div class="media-body">
      ...
      Cookie candy dragée marzipan gingerbread pie pudding. Brownie fruitcake wafer bonbon gummi bears
      apple pie. Brownie lemon drops chocolate cake donut croissant cotton candy.
    </div>
  </div>
  <div class="media">
    <a class="media-left" href="javascript:void(0)">
      <img
        src="assets/images/portrait/small/avatar-s-6.jpg"
        alt="Generic placeholder image"
        height="64"
        width="64"
      />
    ...
    <div class="media-body">
      ...
      Tootsie roll dessert tart candy canes ice cream gingerbread cookie. Jelly jelly-o bear claw bear
      claw halvah. Biscuit icing pastry tootsie roll gingerbread croissant chupa chups.
    </div>
  </div>
  <div class="media">
    <a class="media-left" href="javascript:void(0)">
...
export const snippetCodeRightAligned: snippetCode = {
  html: `
<div class="media-list">
  <div class="media">
    <div class="media-body text-right">
      <h4 class="media-heading">Oat cake</h4>
      Oat cake topping oat cake jelly soufflé donut jelly-o tootsie roll. Candy sweet cake. Tiramisu
      cookie toffee donut. Chocolate pie croissant gummi bears muffin dessert chocolate.
    </div>
    <a class="media-right" href="javascript:void(0)">
      <img
...
export const snippetCodeLeftAlignedBordered: snippetCode = {
  html: `
<div class="media-list media-bordered">
  <div class="media">
    <a class="media-left" href="javascript:void(0)">
      <img
        src="assets/images/portrait/small/avatar-s-23.jpg"
        alt="Generic placeholder image"
        height="64"
        width="64"
      />
  ...
  <div class="media">
    <a class="media-left" href="javascript:void(0)">
      <img
        src="assets/images/portrait/small/avatar-s-15.jpg"
        alt="Generic placeholder image"
        height="64"
        width="64"
      />
...
export const snippetCodeBordered: snippetCode = {
  html: `
<div class="media-list media-bordered">
  <div class="media">
    <div class="media-body text-right">
    ...
    <a class="media-right" href="javascript:void(0)">
      <img
        ...
        src="assets/images/portrait/small/avatar-s-9.jpg"
        alt="Generic placeholder image"
        height="64"
        width="64"
      />
  ...
  <div class="media">
    ...
    <a class="media-right" href="javascript:void(0)">
      <img
        class="rounded-circle"
        src="assets/images/portrait/small/avatar-s-14.jpg"
        alt="Generic placeholder image"
        height="64"
        width="64"
      />
  ...
  <div class="media">
    ...
    <a class="media-right" href="javascript:void(0)">
      <img
        class="rounded-circle"
        src="assets/images/portrait/small/avatar-s-21.jpg"
        alt="Generic placeholder image"
        height="64"
        width="64"
      />
...
export const snippetCodeNested: snippetCode = {
  html: `
<div class="media">
  <img
  ...
  <div class="media-body">
    ...
    <div class="media mt-3">
      <a class="mr-1" href="javascript:void(0)">
        <img
          src="assets/images/portrait/small/avatar-s-13.jpg"
          alt="img placeholder"
          height="64"
          width="64"
        />
...
export const snippetCodeAlignedLeft: snippetCode = {
  html: `
<div class="media-list media-bordered">
  <div class="media">
    <a class="align-self-start media-left" href="javascript:void(0)">
      <img
    ...
    <div class="media-body">
      ...
      <p class="mb-0">
        Chocolate pudding jelly beans powder carrot cake pastry. Sweet candy dragée cake brownie
        cheesecake jelly beans tart lemon drops. Liquorice cake fruitcake dragée sesame snaps candy canes
        biscuit pastry.
      </p>
      <p class="mb-0">
        Cookie caramels brownie carrot cake macaroon brownie pastry. Donut powder croissant tootsie roll
        cake cupcake. Cake tart icing jelly-o ice cream tootsie roll bear claw toffee brownie. Sugar plum
        danish muffin gummi bears.
      </p>
      <p class="mb-0">
  ...
  <div class="media">
    <a class="media-left align-self-center" href="javascript:void(0)">
      <img
        src="assets/images/portrait/small/avatar-s-1.jpg"
        alt="Generic placeholder image"
        height="64"
    ...
    <div class="media-body">
      ...
      <p class="mb-0">
        ...
        Apple pie jelly gummies tiramisu macaroon tiramisu oat cake. Apple pie tiramisu cake chocolate
        cake topping danish sweet apple pie sugar plum.
      </p>
    </div>
  </div>
  <div class="media">
    <a class="media-left align-self-end" href="javascript:void(0)">
      <img
        src="assets/images/portrait/small/avatar-s-16.jpg"
        alt="Generic placeholder image"
        height="64"
    ...
    <div class="media-body">
      ...
      <p class="mb-0">
        Sweet sesame snaps dragée chocolate tiramisu cotton candy sweet roll bonbon dessert. Chocolate
        cake tiramisu dragée. Carrot cake pudding marshmallow fruitcake carrot cake.
      </p>
      <p class="mb-0">
        Cotton candy pastry chocolate bar. Apple pie sesame snaps macaroon muffin cookie toffee bonbon
        gummies candy canes. Soufflé chocolate bar soufflé tart fruitcake muffin. Macaroon sweet roll
        apple pie jelly beans powder pudding.
      </p>
      <p class="mb-0">
