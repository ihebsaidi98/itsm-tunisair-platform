 ...
 * You can also change them on each component basis. i.e `app/main/pages/authentication/auth-login-v1/login.component.ts`
 *
...
export const coreConfig: CoreConfig = {
  app: {
    appName     : 'Tunisair',                                        // App Name
    appTitle    : 'Tunisair', // App Title
    appLogoImage: 'assets/images/tunisiar.png',                  // App Logo
